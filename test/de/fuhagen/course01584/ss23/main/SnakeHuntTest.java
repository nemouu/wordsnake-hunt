...
class SnakeHuntTest {
	...
	class Einfache_Tests {
		...
		void testeLoeseProbleminstanzEinfach() {
			assertTrue(
					jagd.solveProblem("res/sj_p1_probleminstanz.xml",
		...
		void testeLoeseProbleminstanzEinfachUnvollstaendig() {
			assertFalse(
					jagd.solveProblem("res/sj_p1_unvollstaendig.xml",
		...
		void testeLoeseProbleminstanzEinfachAusnahme() {
			assertFalse(
					jagd.solveProblem("res/s_p1_unvollstaendig.xml",
							"res/sj_p1_unvollstaendig_einfach_test.xml"),
		...
		void testeLoeseProbleminstanzEinfachAusgabeExistiertNicht() {
			assertFalse(
					jagd.solveProblem("res/sj_p1_unvollstaendig.xml", "res/sj_p1_unvollstaendig_einfach_test.l"),
		...
		void testeErzeugeProbleminstanzEinfach() {
			assertTrue(
					jagd.generateProblem("res/sj_p1_unvollstaendig.xml",
							"res/sj_p1_unvollstaendig_einfach_test.xml"),
		...
		void testeErzeugeProbleminstanzFehler() {
			assertFalse(
					jagd.generateProblem("res/sj_p1_staendig.xml", "res/sj_p1_unvollstaendig_einfach_test.xml"),
		...
		void testeErzeugeProbleminstanzEinfachAusgabeExistiertNicht() {
			assertFalse(
					jagd.generateProblem("res/s_p1_unvollstaendig.xml",
		...
		void testePruefeLoesungOhneFehler() {
			...
			assertIterableEquals(fehler, jagd.examineSolution("res/sj_p1_loesung.xml"),
		...
		void testePruefeLoesungEins() {
			...
			fehler.add(ErrorType.GLIEDER);
			assertIterableEquals(fehler, jagd.examineSolution("res/sj_p11_loesung_fehler.xml"),
		...
		void testePruefeLoesungZwei() {
			...
			assertIterableEquals(fehler, jagd.examineSolution("res/sj_p12_loesung_fehler.xml"),
					"\nDie Pruefung hat keine oder nicht die richtigen Fehler gefunden, obwohl die gegebene Loesung Fehler enthaelt.");
		}
		...
		void testePruefeLoesungDrei() {
			...
			assertIterableEquals(fehler, jagd.examineSolution("res/sj_p13_loesung_fehler.xml"),
					"\nDie Pruefung hat keine oder nicht die richtigen Fehler gefunden, obwohl die gegebene Loesung Fehler enthaelt.");
		}
		...
		void testePruefeLoesungVier() {
			...
			assertIterableEquals(fehler, jagd.examineSolution("res/sj_p14_loesung_fehler.xml"),
					"\nDie Pruefung hat keine oder nicht die richtigen Fehler gefunden, obwohl die gegebene Loesung Fehler enthaelt.");
		}
		...
		void testePruefeLoesungEingabeDateiFalsch() {
			List<ErrorType> fehler = new ArrayList<ErrorType>();
			assertIterableEquals(fehler, jagd.examineSolution("res/sj_p1esung_fehler.xml"),
	...
	class Parametrisierte_Tests {
		...
		void testeLoeseProbleminstanzMitProbleminstanzen(int nr) {
			assertTrue(
					jagd.solveProblem("res/sj_p" + nr + "_probleminstanz.xml",
		...
		void testeLoeseProbleminstanzMitNichtVorhandenemDschungel(int nr) {
			assertFalse(
					jagd.solveProblem("res/sj_p" + nr + "_unvollstaendig.xml",
		...
		void testeBewerteProbleminstanz(int ergebnis) {
			assertEquals(ergebnis, jagd.evaluateSolution("res/sj_p" + zaehlen + "_loesung.xml"),
